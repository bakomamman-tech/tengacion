...
const FEATURE_DEFINITIONS = [
  ...
  },
  {
    ...
    access: "authenticated",
    route: "/purchases",
    pathPatterns: [/^\/purchases(?:[/?#].*)?$/i],
    description: "Review the songs, books, podcasts, and other creator content you have unlocked.",
    safeDescription: "Open your purchased content and access library.",
    allowedActions: ["open owned content", "review purchases", "view payment status"],
    quickPrompts: [
      "Open my purchases",
      "What did I buy?",
      "How do I buy a song?",
      "Open a song I purchased",
    ],
  },
  {
    id: "profile_editor",
  ...
  },
  {
    ...
    pathPatterns: [
      /^\/creator\/(?!dashboard(?:[/?#]|$)|categories(?:[/?#]|$)|music(?:[/?#]|$)|books(?:[/?#]|$)|podcasts(?:[/?#]|$)|earnings(?:[/?#]|$)|payouts(?:[/?#]|$)|settings(?:[/?#]|$)|verification(?:[/?#]|$)|support(?:[/?#]|$)|fan-page-view(?:[/?#]|$)|register(?:[/?#]|$))[^/?#]+\/?(?:[?#].*)?$/i,
    ],
  ...
  },
  {
    ...
    aliases: ["creator categories", "creator lanes", "content categories", "creator types"],
    surface: "creator_dashboard",
    access: "creator",
    route: "/creator/categories",
    pathPatterns: [/^\/creator\/categories(?:[/?#].*)?$/i],
    description: "Choose which creator lanes are active on your profile and jump into each upload workspace.",
    safeDescription: "Manage the creator categories and lanes enabled on your profile.",
    allowedActions: ["enable creator lane", "disable creator lane", "open upload workspace"],
    quickPrompts: [
      "How do I enable a creator category?",
      "Open creator categories",
      "Which creator lanes are active on my profile?",
    ],
  },
  {
    id: "creator_music_workspace",
    title: "Creator Music Workspace",
    aliases: ["creator music", "music workspace", "manage music", "music catalog", "music releases"],
    surface: "creator_music_upload",
    access: "creator",
    route: "/creator/music",
    pathPatterns: [/^\/creator\/music\/?$/i],
    description: "Manage published and draft tracks, albums, and music videos, then update metadata without leaving the creator workspace.",
    safeDescription: "Open the creator music workspace to manage releases and metadata.",
    allowedActions: ["review releases", "edit metadata", "open music upload"],
    quickPrompts: [
      "Open my music workspace",
      "How do I edit a track or album?",
      "Show my published and draft music",
    ],
  },
  {
    id: "creator_books_workspace",
    title: "Creator Books Workspace",
    aliases: ["creator books", "books workspace", "manage books", "book catalog", "published books"],
    surface: "creator_books_upload",
    access: "creator",
    route: "/creator/books",
    pathPatterns: [/^\/creator\/books\/?$/i],
    description: "Review published and draft books, update metadata, and jump to the dedicated manuscript upload flow.",
    safeDescription: "Open the creator books workspace to manage your catalog and book metadata.",
    allowedActions: ["review books", "edit metadata", "open book upload"],
    quickPrompts: [
      "Open my books workspace",
      "How do I edit book metadata?",
      "Show my published and draft books",
    ],
  },
  {
    id: "creator_podcasts_workspace",
    title: "Creator Podcasts Workspace",
    aliases: ["creator podcasts", "podcast workspace", "manage podcasts", "podcast catalog", "episodes and drafts"],
    surface: "creator_podcasts_upload",
    access: "creator",
    route: "/creator/podcasts",
    pathPatterns: [/^\/creator\/podcasts\/?$/i],
    description: "Manage podcast episodes, update show metadata, and move into the dedicated podcast upload flow when you need a new release.",
    safeDescription: "Open the creator podcasts workspace to manage episodes and metadata.",
    allowedActions: ["review episodes", "edit metadata", "open podcast upload"],
    quickPrompts: [
      "Open my podcasts workspace",
      "How do I edit a podcast episode?",
      "Show my podcast drafts",
    ],
  },
  {
    ...
    pathPatterns: [/^\/creators\/[^/?#]+\/subscribe(?:[/?#].*)?$/i],
    description: "Review creator membership benefits and start secure monthly checkout for supporter access.",
    safeDescription: "Open the secure creator membership checkout page.",
    allowedActions: ["review benefits", "start secure checkout", "check subscription status"],
    quickPrompts: [
      "How do I subscribe to a creator?",
      "Open creator membership",
      "What does a creator subscription unlock?",
    ],
  },
  {
    id: "public_creator_profile",
    ...
    pathPatterns: [
      /^\/creators\/[^/?#]+\/?(?:[?#].*)?$/i,
      /^\/creators\/[^/?#]+\/(?:songs|music|albums|podcasts|books|comedy|store)\/?(?:[?#].*)?$/i,
      /^\/creator\/[^/?#]+\/(?:music|albums|podcasts|books|comedy|store)\/?(?:[?#].*)?$/i,
    ],
    description: "View a creator's public profile, catalog sections, membership entry points, and creator store links.",
    safeDescription: "Open a public creator profile or catalog section.",
    allowedActions: ["view creator profile", "browse creator catalog", "open creator store"],
    quickPrompts: [
      "Open a creator profile",
      "How do I browse a creator's catalog?",
      "Where do I find creator music and books?",
    ],
  },
  {
    id: "creator_content_detail",
    title: "Creator Content Detail",
    aliases: [
      "track detail",
      "song detail",
      "book detail",
    ...
    description: "Review paid creator tracks, books, or albums, then use the secure checkout and entitlement flow.",
    safeDescription: "Open creator content pages and secure purchase status.",
    allowedActions: ["review content", "start secure checkout", "open unlocked content"],
    quickPrompts: [
      "How do I unlock creator content?",
      "Open my purchases",
      "What happens after I buy a track?",
    ],
  },
  {
    id: "payment_status",
    ...
    pathPatterns: [/^\/payment\/verify(?:[/?#].*)?$/i, /^\/payments\/callback(?:[/?#].*)?$/i],
    description: "Verify a checkout result and reconnect the user to purchased content after provider payment redirects.",
    safeDescription: "Open payment verification and purchase status.",
    allowedActions: ["verify payment", "review checkout status", "open purchase result"],
    quickPrompts: [
  ...
  },
  {
    id: "marketplace_home",
    title: "Marketplace",
    aliases: ["marketplace", "shop", "products", "browse marketplace", "marketplace home"],
    surface: "marketplace",
    access: "authenticated",
    route: "/marketplace",
    pathPatterns: [/^\/marketplace\/?(?:[?#].*)?$/i],
    description: "Browse marketplace products, stores, search filters, and buyer entry points.",
    safeDescription: "Open the marketplace to browse products and stores.",
    allowedActions: ["browse products", "open store", "search marketplace"],
    quickPrompts: ["Open marketplace", "Find marketplace products", "How do I buy from marketplace?"],
  },
  {
    ...
    description: "Review marketplace product or seller store details before using the buyer checkout flow.",
    safeDescription: "Open marketplace product and store pages.",
    allowedActions: ["review product", "open seller store", "start buyer checkout"],
    quickPrompts: [
      "How do marketplace product pages work?",
      "Open marketplace orders",
      "How do I buy from a seller?",
    ],
  },
  {
    id: "marketplace_orders",
    title: "Marketplace Orders",
    aliases: ["marketplace orders", "buyer orders", "my marketplace orders", "marketplace purchases"],
    surface: "marketplace",
    access: "authenticated",
    route: "/marketplace/orders",
    pathPatterns: [/^\/marketplace\/orders\/?(?:[?#].*)?$/i],
    description: "Review buyer marketplace orders, delivery status, and order history.",
    safeDescription: "Open marketplace buyer orders.",
    allowedActions: ["review orders", "check delivery status", "open order history"],
    quickPrompts: [
      "Open marketplace orders",
      "Where are my buyer orders?",
      "How do I check delivery status?",
    ],
  },
  {
    id: "marketplace_seller_onboarding",
    title: "Marketplace Seller Onboarding",
    aliases: ["become a seller", "seller onboarding", "marketplace registration", "marketplace seller signup"],
    surface: "marketplace",
    access: "authenticated",
    route: "/marketplace/become-seller",
    pathPatterns: [/^\/marketplace\/become-seller\/?(?:[?#].*)?$/i, /^\/marketplace\/register\/?(?:[?#].*)?$/i],
    description: "Start marketplace seller setup, profile review, and payout-readiness preparation.",
    safeDescription: "Open marketplace seller onboarding.",
    allowedActions: ["start seller setup", "review seller requirements", "prepare payout details"],
    quickPrompts: [
  ...
  {
    id: "marketplace_seller_dashboard",
    title: "Marketplace Seller Dashboard",
    aliases: ["seller dashboard", "marketplace dashboard", "seller console", "marketplace seller dashboard"],
    surface: "marketplace",
    access: "authenticated",
    route: "/marketplace/dashboard",
    pathPatterns: [/^\/marketplace\/dashboard\/?(?:[?#].*)?$/i],
    description: "Manage marketplace products, seller readiness, order summaries, and storefront operations.",
    safeDescription: "Open the marketplace seller dashboard.",
    allowedActions: ["manage products", "review seller readiness", "open storefront tools"],
    quickPrompts: [
      "Open seller dashboard",
      "How do I manage marketplace products?",
  ...
  },
  {
    ...
    aliases: ["marketplace payouts", "seller payouts", "seller payout status", "marketplace balance"],
    surface: "marketplace",
    access: "authenticated",
    route: "/marketplace/payouts",
    pathPatterns: [/^\/marketplace\/payouts\/?(?:[?#].*)?$/i],
    description: "Review marketplace seller balances, payout requests, and settlement status.",
    safeDescription: "Open marketplace seller payouts and settlement status.",
    allowedActions: ["review seller balance", "check payout status", "open settlement history"],
    quickPrompts: [
      "Open marketplace payouts",
  ...
  },
  {
    id: "onboarding",
    title: "Onboarding",
    aliases: ["onboarding", "welcome setup", "finish setup", "account setup"],
    surface: "profile",
    access: "authenticated",
    route: "/onboarding",
    pathPatterns: [/^\/onboarding(?:[/?#].*)?$/i],
    description: "Finish your account setup flow and review guided next steps before moving deeper into the app.",
    safeDescription: "Open the account onboarding flow and guided setup steps.",
    allowedActions: ["review setup steps", "complete onboarding", "continue setup"],
    quickPrompts: [
      "Open onboarding",
      "How do I finish account setup?",
      "What should I complete first on Tengacion?",
    ],
  },
  {
    id: "settings_hub",
    title: "Settings Hub",
    aliases: ["settings", "settings hub", "account settings", "privacy hub"],
    surface: "settings",
    access: "authenticated",
    route: "/settings",
    pathPatterns: [/^\/settings\/?$/i],
    description: "Central account controls for security, privacy, notifications, display, sound, and welcome voice preferences.",
    safeDescription: "Open the main settings hub for account controls and privacy tools.",
    allowedActions: [
    ...
    quickPrompts: [
      ...
      "Where do I manage privacy and notifications?",
    ],
  },
  {
    id: "settings_privacy",
    title: "Privacy Settings",
    aliases: ["privacy settings", "privacy", "visibility", "download my data", "account data export"],
    surface: "settings",
    access: "authenticated",
    route: "/settings/privacy",
    pathPatterns: [/^\/settings\/privacy(?:[/?#].*)?$/i],
    description: "Control profile visibility and message access, or download a portable account snapshot.",
    safeDescription: "Open privacy and account-data controls.",
    allowedActions: ["change visibility", "manage message access", "open account data download"],
    quickPrompts: ["How do I change privacy?", "Download my account data", "Who can message me?"],
  },
  {
  ...
  },
  {
    ...
    aliases: ["delete my account", "delete account", "account deletion", "remove my account"],
    surface: "settings",
    access: "authenticated",
    route: "/account-deletion",
    pathPatterns: [/^\/account-deletion(?:[/?#].*)?$/i],
    description: "Review retention details and permanently delete an account after password reauthentication and exact confirmation.",
    safeDescription: "Open the secure account-deletion page; Akuso cannot confirm or perform deletion for you.",
    allowedActions: ["open account deletion controls", "review deletion consequences"],
    quickPrompts: ["How do I delete my account?", "What happens when I delete my account?"],
  },
  {
  ...
  },
  {
    id: "gaming",
    title: "Gaming",
    aliases: ["gaming", "games", "gaming page"],
    surface: "discover",
    access: "authenticated",
    route: "/gaming",
    pathPatterns: [/^\/gaming(?:[/?#].*)?$/i],
    description: "Browse Tengacion's gaming surface and related social content.",
    safeDescription: "Open the gaming page and related discovery content.",
    allowedActions: ["browse gaming content", "open gaming feed"],
    quickPrompts: ["Open gaming", "What can I do on the gaming page?", "Show gaming content"],
  },
  {
    id: "reels",
    title: "Reels",
    aliases: ["reels", "short videos", "short-form videos"],
    surface: "discover",
    access: "authenticated",
    route: "/reels",
    pathPatterns: [/^\/reels(?:[/?#].*)?$/i],
    description: "Browse short-form videos and discover trending visual content.",
    safeDescription: "Open the reels feed for short-form video browsing.",
    allowedActions: ["browse reels", "open short video"],
...
const SURFACE_FALLBACKS = {
  ...
  messages: ["messages", "notifications", "home", "search", "creator_discovery", "purchases"],
  notifications: ["notifications", "messages", "home", "search", "purchases"],
  profile: ["profile_editor", "onboarding", "settings_hub", "settings_privacy", "settings_security", "purchases", "home"],
  creator_onboarding: ["creator_onboarding", "creator_categories", "creator_dashboard", "creator_support"],
  creator_dashboard: ["creator_dashboard", "creator_categories", "creator_music_upload", "creator_books_upload", "creator_podcasts_upload", "creator_earnings", "creator_payouts"],
  creator_music_upload: ["creator_music_upload", "creator_music_workspace", "creator_dashboard"],
  creator_books_upload: ["creator_books_upload", "creator_books_workspace", "creator_dashboard"],
  creator_podcasts_upload: ["creator_podcasts_upload", "creator_podcasts_workspace", "creator_dashboard"],
  creator_finance: ["creator_earnings", "creator_payouts", "creator_dashboard"],
  purchases: ["purchases", "creator_content_detail", "payment_status", "creator_subscription", "home", "messages", "notifications", "search"],
  settings: ["settings_hub", "settings_privacy", "settings_security", "account_deletion", "settings_notifications", "settings_display", "settings_sound", "help_support", "purchases"],
  social: ["friends", "groups", "rooms", "saved", "memories", "events", "birthdays"],
  support: ["help_support", "feedback", "settings_security", "settings_privacy", "account_deletion"],
  utility: ["calculator", "search", "home"],
  business: ["ads_manager", "creator_dashboard", "marketplace_home", "home"],
  marketplace: ["marketplace_home", "marketplace_orders", "marketplace_seller_dashboard", "marketplace_payouts", "marketplace_seller_onboarding", "marketplace_product", "purchases"],
  live: ["live", "live_go_live", "live_watch", "home", "notifications"],
  news: ["news", "news_topic", "news_source", "trending", "home"],
  discover: ["trending", "creator_discovery", "public_creator_profile", "gaming", "reels", "search"],
...
const resolveSurfaceFromPath = (path = "") => {
  ...
  if (route.startsWith("/onboarding")) return "profile";
  ...
  if (route.startsWith("/payment/") || route.startsWith("/payments/") || route.startsWith("/tracks/") || route.startsWith("/books/") || route.startsWith("/albums/")) return "purchases";
  ...
  if (route.startsWith("/trending") || route.startsWith("/gaming") || route.startsWith("/reels")) return "discover";
