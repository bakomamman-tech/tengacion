    ...
    case "whatsapp":
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          />
          <path
            d="M15.7 13.2c-.2-.1-1.2-.6-1.4-.7-.2-.1-.4-.1-.5.1l-.4.5c-.1.2-.3.2-.5.1a6.5 6.5 0 0 1-1.8-1.1 7 7 0 0 1-1.2-1.6c-.1-.2 0-.3.1-.4l.3-.3.2-.4c.1-.1 0-.3 0-.4l-.7-1.5c-.2-.4-.4-.4-.5-.4H8.1c-.2 0-.4.1-.6.3-.2.2-.7.8-.7 1.7s.7 2.1.9 2.3c.1.1 1.6 2.4 3.8 3.2.6.3 1 .4 1.3.5.6.1 1 .2 1.4.1.5-.1 1.2-.6 1.4-1.1.2-.6.2-1 .1-1.1-.1-.2-.3-.2-.4-.3z"
            fill="#fff"
          />
        </svg>
      );
