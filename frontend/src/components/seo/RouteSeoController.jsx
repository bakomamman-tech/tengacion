...
const NOINDEX_RULES = [
  {
    ...
    description:
      "Phase 3 of Tengacion VoiceBridge benchmarks Sahara v2.5, GPT-Transcribe, Whisper-1, and Google Chirp 3 using shared source audio and normalized WER for African digital-commerce support.",
