export const CREATOR_CATEGORY_CONFIG = {
  ...
  podcast: {
    ...
    title: "Podcast",
    shortTitle: "Podcast",
    description: "Publish podcast episodes from a dedicated spoken-audio studio with seasons, series identity, premium gating, and transcripts.",
    route: "/creator/podcasts",
    uploadRoute: "/creator/podcasts/upload",
    uploadTitle: "Podcast Uploads",
    uploadDescription: "Upload podcast episodes only with series metadata, audio, previews, transcripts, and clean premium controls.",
