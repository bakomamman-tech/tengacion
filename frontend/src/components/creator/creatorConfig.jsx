export const CREATOR_CATEGORY_CONFIG = {
  music: {
    ...
    title: "Music",
    shortTitle: "Music",
    description: "Publish music releases from a focused studio built for artwork, metadata, drafts, launch-ready pricing, audio masters, and high-quality music videos.",
    route: "/creator/music",
    uploadRoute: "/creator/music/upload",
    uploadTitle: "Music Uploads",
    uploadDescription: "Upload music only with track metadata, cover art, audio or video media, optional previews, and release-ready controls.",
