    ...
    <div className="gsi-app-shell gsi-dashboard-page">
      ...
      <main className="gsi-dashboard-main">
        ...
        <form className="gsi-dashboard-filters" onSubmit={search}>
          <label className="gsi-dashboard-search"><GsiIcon name="search" size={19} /><input value={draft.q} onChange={update("q")} placeholder="Search title, author, journal, ISSN, OpenAlex ID, topic, country, or DOI" aria-label="Search research" /></label>
