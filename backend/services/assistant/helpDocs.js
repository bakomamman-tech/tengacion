...
const HELP_ARTICLES = [
  ...
  },
  {
    ...
    title: "How to browse a creator profile",
    summary: "Open a public creator profile to review their bio, catalog sections, membership entry points, and store links.",
    featureId: "public_creator_profile",
    route: "/creators/:creatorId",
    keywords: ["creator profile", "creator hub", "creator catalog", "creator music", "creator books", "creator store"],
    steps: [
      "Open the creator's public profile from discovery, search, or a shared creator link.",
      "Use the catalog tabs to review music, albums, podcasts, books, comedy, or store sections when available.",
      "Start purchases or subscriptions only through the built-in checkout pages.",
    ],
  },
  {
    id: "find-creators",
  ...
  {
    id: "creator-content-unlocks",
    title: "How creator content unlocks after payment",
    summary: "Track, book, and album pages connect checkout results to your purchases library after payment verification.",
    featureId: "creator_content_detail",
    route: "/purchases",
    keywords: ["unlock content", "track detail", "book detail", "album detail", "entitlement", "paid content"],
    steps: [
      "Open the track, book, or album page and review the item before checkout.",
      "Finish payment through the secure provider redirect instead of sharing payment details with Akuso.",
      "After verification, open Purchases to access unlocked content if the item page does not refresh automatically.",
    ],
  },
  {
    id: "payment-status",
    title: "How to check payment status",
    summary: "Use payment verification or Purchases to confirm whether checkout succeeded and content was unlocked.",
    featureId: "payment_status",
    route: "/payments/callback",
    keywords: ["payment status", "verify payment", "payment callback", "checkout status", "payment receipt"],
    steps: [
      "Return to Tengacion through the provider callback after checkout.",
      "Let the payment verification page check the provider reference and entitlement state.",
      "Open Purchases if you need to confirm access after a paid checkout.",
    ],
  },
  {
    id: "marketplace-orders",
    title: "How to review marketplace orders",
    summary: "Open Marketplace Orders to check buyer orders, delivery status, and order history.",
    featureId: "marketplace_orders",
    route: "/marketplace/orders",
    keywords: ["marketplace orders", "buyer orders", "delivery status", "marketplace purchases"],
    steps: [
      "Open Marketplace Orders from the marketplace navigation.",
      "Review each order's status, delivery state, and seller details.",
      "Use the order page or support flow if an order needs follow-up.",
    ],
  },
  {
    id: "marketplace-selling",
    title: "How to start selling in the marketplace",
    summary: "Open Marketplace Seller Onboarding to prepare your seller profile, products, and payout details.",
    featureId: "marketplace_seller_onboarding",
    route: "/marketplace/become-seller",
    keywords: ["become a seller", "seller onboarding", "marketplace seller", "seller dashboard"],
    steps: [
      "Open Marketplace Seller Onboarding and complete the seller profile fields.",
      "Review seller readiness before adding products or opening the seller dashboard.",
      "Keep payout details current so settlement review is not blocked later.",
    ],
  },
  {
    id: "marketplace-payouts",
    title: "How to review marketplace payouts",
    summary: "Open Marketplace Payouts to review seller balances, payout requests, and settlement status.",
    featureId: "marketplace_payouts",
    route: "/marketplace/payouts",
    keywords: ["marketplace payouts", "seller payouts", "seller payout status", "marketplace balance"],
    steps: [
      "Open Marketplace Payouts from the seller dashboard or marketplace navigation.",
      "Review available balance, pending settlement, and previous payout requests.",
      "Use only the built-in payout flow; Akuso can guide you but will not move money for you.",
    ],
  },
  {
    id: "go-live",
