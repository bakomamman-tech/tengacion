export const CREATOR_CATEGORY_CONFIG = {
  music: {
    ...
    uploadDescription: "Release tracks, albums, and music videos with artwork, previews, pricing, and screening-ready metadata.",
  ...
  bookPublishing: {
    ...
    uploadDescription: "Publish digital books with cover art, preview files, language details, and storefront-ready metadata.",
    uploadButtonLabel: "Upload Book",
  ...
  podcast: {
    ...
    uploadTitle: "Upload Podcasts",
    uploadDescription: "Set your series profile and publish episodes with pricing, season info, teasers, and artwork.",
    uploadButtonLabel: "Upload Podcasts",
