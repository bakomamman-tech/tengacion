...
const FEATURE_DEFINITIONS = [
  ...
  },
  {
    ...
    description: "Control profile visibility and message access, review limited accounts, or download a portable account snapshot.",
    safeDescription: "Open privacy, account-safety, and account-data controls; Akuso cannot block or unblock an account for you.",
    allowedActions: [
      "change visibility",
      "manage message access",
      "review blocked accounts",
      "open account data download",
    ],
    quickPrompts: [
      "How do I change privacy?",
      "Where do I manage blocked accounts?",
