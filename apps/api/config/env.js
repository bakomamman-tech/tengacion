...
const config = {
  ...
  livekit:
    livekitApiKey || livekitApiSecret || livekitHost || livekitWsUrl
      ...
      : undefined,
  USE_LOCAL_VIDEO_MOCK: ["1", "true", "yes", "on"].includes(toText(process.env.USE_LOCAL_VIDEO_MOCK).toLowerCase()),
  LOCAL_VIDEO_MOCK_URL: toText(process.env.LOCAL_VIDEO_MOCK_URL) || "https://storage.googleapis.com/free-videos/sample.mp4",
